...
//							SyncData();
					...
					{
						throw new MessageException(CsUtilities.nl
							+ "Cannot read setting data for file: "
							+ Info.SettingPathAndFile + CsUtilities.nl
							+ "("                     + e.Message + ")" + CsUtilities.nl
							, e.InnerException);
					}
				}
				else
...
//			public override string RootPath2 => Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData);
