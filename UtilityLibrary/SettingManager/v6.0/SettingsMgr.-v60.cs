...
#region + Header
	...
	public class Heading
	{
		...
		[DataMember(Order = 3)] public string SystemVersion = "6.0";
		[DataMember(Order = 4)] public string DataClassVersion;
		[DataMember(Order = 5)] public string Notes = "created by v6.0";
...
#region + Support Classes
		...
		where Tdata : new()
	{
		...
		[DataMember(Order = 0)] public Heading Header;
		...
		public abstract Heading.SettingFileType  FileType  { get; } //= Heading.SettingFileType.OTHER;
	...
	[DataContract]
	// define file type specific information: User
	public abstract class DataInfoBase<Tdata> : SettingInfoBase<Tdata>
		where Tdata : new()
	{
