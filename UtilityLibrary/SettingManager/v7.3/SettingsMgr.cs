...
#region + Heading
	...
	public partial class Heading
	{
		...
		[DataMember(Order = 0)] public string SaveDateTime       { get; private set; } = DateTime.Now.ToString("yyyy-MM-dd - HH:mm zzz");
		...
		[DataMember(Order = 3)] public string SettingsVersion    { get; private set; } = "7.3";
...
#region + Support Classes
	...
	{
		string SetDataDescription();
		string SetDataNotes();
		string SetDataClassVersion();
	}
		...
		where TData : HeaderData, new()
	{
		...
		protected SettingInfoBase()
		{
				...
				Description = Data.SetDataDescription();
				DataClassVersion = Data.SetDataClassVersion();
				Notes = Data.SetDataNotes();
		}
...
#region management classes for data
	...
	public class BaseDataFile<TData> : INotifyPropertyChanged
		where TData : class, HeaderData, new()
	{
